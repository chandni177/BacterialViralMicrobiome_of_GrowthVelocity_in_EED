...
length(unique(significantPhageAbundanceDF$ASV)) # 13 taxa
...
length(unique(sigPhageNlAbd$ASV)) # 13 taxa
...
pheatmap(correlationMatrices$Moderate,
         na_col = "grey", cluster_rows = FALSE, cluster_cols = FALSE)

pheatmap(correlationMatrices$Poor,
         na_col = "grey", cluster_rows = FALSE, cluster_cols = FALSE)
```

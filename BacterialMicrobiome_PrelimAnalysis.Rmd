...
ps0 <- readRDS("ps0.EE_holtz.rdp.RDS")
ps0
...
map <- import_qiime_sample_data("EE_mapping_16S_v2.txt")
dim(map)
...
#phyloseq-class experiment-level object
#otu_table()   OTU Table:         [ 3403 taxa and 157 samples ]
#sample_data() Sample Data:       [ 157 samples by 45 sample variables ]
#tax_table()   Taxonomy Table:    [ 3403 taxa by 7 taxonomic ranks ]
#phy_tree()    Phylogenetic Tree: [ 3403 tips and 3401 internal nodes ]
...
ps1
#phyloseq-class experiment-level object
#otu_table()   OTU Table:         [ 3403 taxa and 144 samples ]
#sample_data() Sample Data:       [ 144 samples by 45 sample variables ]
#tax_table()   Taxonomy Table:    [ 3403 taxa by 7 taxonomic ranks ]
#phy_tree()    Phylogenetic Tree: [ 3403 tips and 3401 internal nodes ]
...
ps2
#phyloseq-class experiment-level object
#otu_table()   OTU Table:         [ 2420 taxa and 144 samples ]
#sample_data() Sample Data:       [ 144 samples by 46 sample variables ]
#tax_table()   Taxonomy Table:    [ 2420 taxa by 7 taxonomic ranks ]
#phy_tree()    Phylogenetic Tree: [ 2420 tips and 2531 internal nodes ]

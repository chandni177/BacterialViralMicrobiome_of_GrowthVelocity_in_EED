...
```{r plot-alpha-div-fxn, eval=FALSE}
...
```{r figure2pC-bacterial-richness - unpaired, eval=FALSE}
#----- unpaired analysis -----#
...
```{r figure2pD-bacterial-diversity - unpaired, eval=FALSE}
#----- unpaired analysis -----#

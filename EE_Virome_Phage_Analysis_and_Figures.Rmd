...
richRegContHAZ <- lm(Observed ~ delta_HAZ + HAZ + age_months + gender + bf_at_sampling + (1|patient_ID), 
                     data = phageAlphaDiv)
summary(richRegContHAZ)

divRegContHAZ <- lm(Shannon ~ delta_HAZ + HAZ + age_months + gender + bf_at_sampling + (1|patient_ID), 
                     data = phageAlphaDiv)

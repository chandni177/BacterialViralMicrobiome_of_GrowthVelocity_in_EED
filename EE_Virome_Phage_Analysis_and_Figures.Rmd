...
RunAdonis(physeqPriorAllEEPhage, distance = "bray", 
          category = "Growth_Status_Prior") # p = 0.069
...
mdsBrayPhage <- ggplot(mdsBrayPhageDF, 
  ...
  annotate("text", x = -0.1, y = 0.3, label = "p = 0.069", size = 3.5) +
...
sample_data(physeqPhageNoModerate)$bf_at_sampling <- as.character(sample_data(physeqPhageNoModerate)$bf_at_sampling)

sample_data(physeqPhageNoModerate)$bf_at_sampling[is.na(sample_data(physeqPhageNoModerate)$bf_at_sampling)] <- "unknown"
...
length(unique(phageSigASVDF$OTU)) # 17
...
sigPhageNamesShort <- c("unclassified Caudovirales",
                        "Siphoviridae",
                        "unclassified Myoviridae Bacillus phage BCD7",
                        "unclassified Siphoviridae Croceibacter phage P2559S",
                        "unclassified phage",
                        "unclassified Podoviridae Pseudomonas phage AF",
                        "unclassified Lactococcus phage",
                        "unclassified Podoviridae Pelagibacter phage HTVC010P",
                        "unclassified Siphoviridae Croceibacter phage P2559Y",
                        "Microviridae Gokushovirinae Bdellomicrovirus Bdellovibrio virus MH2K",
